...
/*
By Austin J Parker, Sarvesh Somasundaram, Abdullah 
*/
    ...
    public void start(Stage primaryStage)throws FileNotFoundException {
        ...
        bubblebtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                ClipPlay.playSound("movie_1.wav");
            }
        });
        ...
        bubblebtn1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                ClipPlay.playSound("anime-wow-sound-effect.wav");
            }
        });
        ...
        bubblebtn2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                ClipPlay.playSound("fullsizerender_r8BCkch.wav");
            }
        });
        ...
        mgfbtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                String mergevisual = Arrays.toString(unSorted);
                mergeLabel.setText("The sorted Array: " + mergevisual);
                ClipPlay.playSound("movie_1.wav");
        ...
        quickLabel.setMinSize(150, 400);
        quickLabel.setPadding(new Insets(0, 0, 0, 550));
        Image image2 = new Image(new FileInputStream("Quicksort-example.gif"));
        ...
        quickpane.getChildren().addAll(quick, quickbtns, quickLabel, imageView2);
        ...
        quickbtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                String quickVisual = Arrays.toString(unSorted);
                quickLabel.setText("The sorted Array: " + quickVisual);
                 ClipPlay.playSound("movie_1.wav");
            }
        });
